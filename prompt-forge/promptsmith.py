...
FORGE_PROFILES = {
    "wan": (
        ...
        "— never redesign or restyle it, but DO anchor identity with a stillness "
        "inventory: name the distinctive details from the user's description and "
        "state they 'stay exactly as drawn' or 'perfectly still' (proven to help "
        "the model hold identity). Structure each prompt: (1) one-line framing of "
        "the subject as given, (2) the ONE continuous action in present tense with "
